...
const MarketingRouter = () => (
  <Routes>
    ...
    <Route path="/signup" element={<ExternalRedirect url="https://app.mzatinova.com/signup" />} />
...
const MainContent = () => {
  ...
  const isLiveAppDomain = hostname === "app.mzatinova.com" || hostname.startsWith("app.");

  // Rule 2: Is the developer testing on their computer AND trying to view the software?
  const isLocalHost = hostname === "localhost" || hostname === "127.0.0.1";
  const isTryingToAccessSoftware = location.pathname.startsWith("/login") ||
