        ...
        <div className="relative max-w-7xl mx-auto px-5 py-12 lg:py-16">
          <div className="max-w-4xl mx-auto text-center">
            {/* <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-200 mb-6">
              ...
              <span className="text-xs font-medium text-blue-700 tracking-wide">LIVE PLATFORM · 99.9% UPTIME</span>
            </div> */}
...
//       {/* Header */}
//       <header className="sticky top-0 z-50 backdrop-blur-xl bg-[#05070f]/90 border-b border-white/5">
//         <div className="max-w-7xl mx-auto px-5 h-16 flex items-center justify-between">
//           <div onClick={() => scrollTo('home')} className="flex items-center gap-2 cursor-pointer group">
...
//           <nav className="hidden md:flex items-center gap-6">
//             <button onClick={() => scrollTo('home')} className="text-sm font-medium text-slate-400 hover:text-white transition-colors">Home</button>
//             <button onClick={() => scrollTo('products')} className="text-sm font-medium text-slate-400 hover:text-white transition-colors">Products</button>
//             <button onClick={() => scrollTo('setup')} className="text-sm font-medium text-slate-400 hover:text-white transition-colors">Setup Your School</button>
//           </nav>
          
//           <div className="flex items-center gap-3">
//             <div className="relative">
//               <button onClick={() => setTrayOpen(!trayOpen)} className="h-9 px-3 rounded-lg bg-white/5 border border-white/10 text-sm font-medium flex items-center gap-2 hover:bg-white/10 transition-all text-slate-200">
...
//                 <>
//                   <div className="fixed inset-0 z-10" onClick={() => setTrayOpen(false)} />
//                   <div className="absolute right-0 mt-2 w-72 rounded-2xl border border-white/10 bg-[#0b0f19] p-2 shadow-2xl z-20">
//                     <p className="px-3 py-2 text-[10px] font-bold uppercase tracking-wider text-slate-500">Quick Access</p>
//                     {products.map((prod) => {
//                       const Icon = prod.icon;
//                       return (
//                         <a key={prod.title} href={prod.loginUrl} target="_blank" rel="noreferrer" className="flex items-center gap-3 p-3 rounded-xl hover:bg-white/5 transition-all group" onClick={() => setTrayOpen(false)}>
//                           <div className={`w-8 h-8 rounded-lg ${prod.color === 'cyan' ? 'bg-cyan-500/10' : 'bg-purple-500/10'} flex items-center justify-center`}>
//                             <Icon className={`w-4 h-4 ${prod.color === 'cyan' ? 'text-cyan-400' : 'text-purple-400'}`} />
//                           </div>
//                           <div className="flex-1">
//                             <p className="text-sm font-semibold text-white group-hover:text-cyan-400 transition-colors">{prod.title}</p>
//                             <p className="text-[10px] text-slate-400">Click to open</p>
//                           </div>
...
//               )}
//             </div>
//             <button onClick={() => scrollTo('setup')} className="h-9 px-4 rounded-lg bg-gradient-to-r from-cyan-500 to-cyan-600 hover:from-cyan-600 hover:to-cyan-700 text-white text-sm font-semibold transition-all">Get Started</button>
...
//         </div>
//         {mobileMenuOpen && (
//           <div className="md:hidden border-t border-white/5 py-4 px-5 space-y-3">
//             <button onClick={() => scrollTo('home')} className="block w-full text-left py-2 text-sm font-medium text-slate-400">Home</button>
//             <button onClick={() => scrollTo('products')} className="block w-full text-left py-2 text-sm font-medium text-slate-400">Products</button>
//             <button onClick={() => scrollTo('setup')} className="block w-full text-left py-2 text-sm font-medium text-slate-400">Setup Your School</button>
//           </div>
//         )}
//       </header>

//       {/* ========== HOME SECTION - REDUCED PADDING ========== */}
//       <section id="home" className="relative min-h-[90vh] flex items-center overflow-hidden">
...
//         <div className="absolute inset-0 opacity-5" style={{ backgroundImage: `linear-gradient(to right, #0ff 1px, transparent 1px), linear-gradient(to bottom, #0ff 1px, transparent 1px)`, backgroundSize: '50px 50px' }} />
        
//         <div className="relative max-w-7xl mx-auto px-5 py-12 lg:py-16">
//           <div className="max-w-4xl mx-auto text-center">
//             {/* <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-6 backdrop-blur-sm">
...
//               <span className="text-xs font-medium text-cyan-400 tracking-wide">LIVE PLATFORM · 99.9% UPTIME</span>
//             </div> */}
//             <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight text-white leading-[1.1] mb-4">
//               Run your school.<br />
//               <span className="bg-gradient-to-r from-cyan-400 via-cyan-500 to-purple-500 bg-clip-text text-transparent">Not your paperwork.</span>
//             </h1>
//             <p className="text-lg sm:text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed mb-6">
//               EduSpace is the complete digital platform for African schools, connecting administrators, teachers, parents, and students through one integrated system.
//             </p>
//             <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
//               <button onClick={() => scrollTo('setup')} className="group h-14 px-8 rounded-2xl bg-gradient-to-r from-cyan-500 to-cyan-600 hover:from-cyan-600 hover:to-cyan-700 text-white font-semibold flex items-center justify-center gap-2 shadow-lg shadow-cyan-500/25 transition-all duration-300 hover:scale-105">
//                 Setup Your School <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
//               </button>
//             </div>
...
//                   <div className="text-xs text-slate-500 uppercase tracking-wider flex items-center justify-center gap-1.5">
//                     <stat.icon className="w-3 h-3 text-cyan-400" /> {stat.label}
//                   </div>
//                 </div>
//               ))}
//             </div>
...
//       {/* ========== PRODUCTS SECTION - REDUCED PADDING, NO TOP BORDER ========== */}
//       <section id="products" className="py-16">
//         <div className="max-w-5xl mx-auto px-5">
//           <div className="text-center mb-10">
//             <h2 className="text-3xl font-bold text-white mb-2">EduSpace Products</h2>
//             <p className="text-slate-400">Two portals. One platform. Connected in real-time.</p>
//           </div>
...
//               return (
//                 <div key={product.title} className="group relative p-6 rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.03] to-transparent hover:border-white/20 hover:bg-white/[0.05] transition-all duration-300">
//                   <div className={`absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 ${isCyan ? 'bg-cyan-500/5' : 'bg-purple-500/5'} blur-xl`} />
                  
//                   <div className="relative">
//                     <div className={`w-12 h-12 rounded-xl ${isCyan ? 'bg-cyan-500/10 text-cyan-400' : 'bg-purple-500/10 text-purple-400'} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}>
...
//                       target="_blank" 
//                       rel="noreferrer" 
//                       className={`inline-flex items-center gap-2 text-sm font-semibold transition-all group/link ${isCyan ? 'text-cyan-400 hover:text-cyan-300' : 'text-purple-400 hover:text-purple-300'}`}
//                     >
//                       Access Portal <ExternalLink className="w-3.5 h-3.5 group-hover/link:translate-x-0.5 transition-transform" />
//                     </a>
//                   </div>
//                 </div>
//               );
...
//       {/* ========== SETUP SECTION - REDUCED PADDING ========== */}
//       <section id="setup" className="py-16 border-t border-white/5 bg-gradient-to-b from-transparent to-cyan-500/[0.03]">
//         <div className="max-w-3xl mx-auto px-5">
//           <div className="text-center mb-8">
//             <h2 className="text-3xl font-bold text-white mb-3">Setup Your School</h2>
//             <p className="text-slate-400 text-sm">Provide your school details below. Our team will set up your EduSpace instance and contact you.</p>
//           </div>
          
//           <div className="p-6 rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.02] to-transparent">
//             {!submitted ? (
//               <form onSubmit={handleSubmit} className="space-y-5">
//                 <div className="grid sm:grid-cols-2 gap-5">
//                   <div>
//                     <label className="block text-xs font-semibold text-slate-300 uppercase tracking-wider mb-1.5">School / Institution Name</label>
//                     <input type="text" placeholder="e.g., Progress Private Primary" className="w-full h-11 rounded-xl bg-white/5 border border-white/10 px-4 text-sm text-white focus:outline-none focus:border-cyan-500 transition-all" value={formData.schoolName} onChange={e => setFormData({...formData, schoolName: e.target.value})} required />
//                   </div>
//                   <div>
//                     <label className="block text-xs font-semibold text-slate-300 uppercase tracking-wider mb-1.5">Director / Contact Person</label>
//                     <input type="text" placeholder="e.g., John Banda" className="w-full h-11 rounded-xl bg-white/5 border border-white/10 px-4 text-sm text-white focus:outline-none focus:border-cyan-500 transition-all" value={formData.directorName} onChange={e => setFormData({...formData, directorName: e.target.value})} required />
//                   </div>
//                 </div>
//                 <div className="grid sm:grid-cols-2 gap-5">
//                   <div>
//                     <label className="block text-xs font-semibold text-slate-300 uppercase tracking-wider mb-1.5">WhatsApp Contact Number</label>
//                     <input type="tel" placeholder="e.g., +265 999 000 000" className="w-full h-11 rounded-xl bg-white/5 border border-white/10 px-4 text-sm text-white focus:outline-none focus:border-cyan-500 transition-all font-mono" value={formData.whatsapp} onChange={e => setFormData({...formData, whatsapp: e.target.value})} required />
//                   </div>
//                   <div>
//                     <label className="block text-xs font-semibold text-slate-300 uppercase tracking-wider mb-1.5">Email Address</label>
//                     <input type="email" placeholder="e.g., director@school.com" className="w-full h-11 rounded-xl bg-white/5 border border-white/10 px-4 text-sm text-white focus:outline-none focus:border-cyan-500 transition-all" value={formData.email} onChange={e => setFormData({...formData, email: e.target.value})} />
//                   </div>
//                 </div>
//                 <div>
//                   <label className="block text-xs font-semibold text-slate-300 uppercase tracking-wider mb-1.5">Estimated Student Population</label>
//                   <select className="w-full h-11 rounded-xl bg-white/5 border border-white/10 px-4 text-sm text-slate-300 focus:outline-none focus:border-cyan-500 transition-all" value={formData.studentCount} onChange={e => setFormData({...formData, studentCount: e.target.value})}>
//                     <option value="under-200">Under 200 Students</option>
//                     <option value="200-500">200 - 500 Students</option>
//                     <option value="500-1000">500 - 1,000 Students</option>
//                     <option value="above-1000">More than 1,000 Students</option>
//                   </select>
//                 </div>
//                 <button type="submit" className="w-full h-12 rounded-xl bg-gradient-to-r from-cyan-500 to-cyan-600 hover:from-cyan-600 hover:to-cyan-700 text-white font-semibold text-sm flex items-center justify-center gap-2 transition-all shadow-lg shadow-cyan-500/25">
...
//                 </div>
//                 <h2 className="text-xl font-bold text-white mb-2">Setup Request Received!</h2>
//                 <p className="text-slate-400 text-sm mb-4">Thank you for choosing EduSpace. A support representative will contact you on WhatsApp within 24 hours to guide you through activation.</p>
//                 <button onClick={() => setSubmitted(false)} className="px-5 py-2 rounded-xl bg-cyan-500 hover:bg-cyan-600 text-white font-medium text-sm transition-all">Submit Another Request</button>
//               </div>
//             )}
//           </div>
//         </div>
