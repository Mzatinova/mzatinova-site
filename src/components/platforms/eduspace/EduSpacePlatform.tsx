...
import { 
  ...
  Phone, Mail, MapPin, MessageCircle, Star, BookOpen, Clock, GraduationCap
} from 'lucide-react';
...
const EduSpacePlatform: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setFormData({ schoolName: '', directorName: '', whatsapp: '', email: '', studentCount: 'under-200' });
    }, 3000);
  };
  ...
  const products = [
    {
      ...
      description: 'Complete school management system. Manage results, attendance, fees, students, teachers, classes, and parent portal in one place.',
      icon: Layers,
    ...
    },
    {
      id: 'hub',
      title: 'EduSpace Hub',
      description: 'Education marketplace and learning ecosystem. Course marketplace, library services, public lessons, find a tutor, exam prep, and career guidance.',
  ...
  const testimonials = [
    {
      quote: "EduSpace Portal transformed how we manage our school. Results, attendance, and fees all in one place.",
      author: "John Banda",
      title: "Director, Progress Private Primary"
    },
    {
      quote: "The Hub marketplace helped our teachers earn extra income by selling courses. Parents love the find-a-tutor feature.",
      author: "Mary Kalima",
      title: "Principal, Kasama Community College"
    },
    {
      quote: "Managing 500+ students used to be chaos. Now it's effortless. EduSpace is a game changer for African schools.",
      author: "Peter Mwale",
      title: "Owner, Mwale Academy"
    }
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Mzatinova EduSpace | School Management Platform for Modern Schools</title>
        <meta name="description" content="Complete school management platform for modern schools. Track attendance, report cards, fees, and parent communication in one integrated system." />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://eduspace.mzatinova.com/" />
      </Helmet>
      ...
      <div className="min-h-screen bg-white text-slate-800 font-sans antialiased selection:bg-blue-500/20">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-5 h-16 flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center flex-1">
              ...
              <div className="flex items-center gap-3 flex-shrink-0">
                ...
                <button onClick={openSetupModal} className="h-9 px-4 rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white text-sm font-semibold transition-all shadow-md">Setup Your School</button>
              </div>
            </div>
        ...
        <section className="py-16 bg-white border-y border-slate-100">
          <div className="max-w-4xl mx-auto px-5">
            <div className="text-center mb-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-2">
                What Schools <span className="text-blue-600">Say</span>
              </h2>
            </div>
        ...
        {/* CONTACT SECTION - Same style as CloudSpace */}
              ...
              <div className="flex justify-between items-center mb-6">
                <div>
                  <h2 className="text-2xl font-bold text-slate-800">
                    {step === 'select' ? 'Select a Product' : `Setup ${getSelectedProduct()?.title || 'Your School'}`}
                  </h2>
                ...
                <>
                  {!submitted ? (
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-slate-700 mb-1">Student Population</label>
                        <select 
                    ...
                    <div className="py-10 text-center space-y-4">
                      ...
                      <p className="text-slate-500 text-sm max-w-sm mx-auto">
                        Thank you for choosing EduSpace. We'll contact you on WhatsApp within 24 hours to get you started.
                      </p>
                    </div>
                  )}
                </>
