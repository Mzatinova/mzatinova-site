    ...
    const updates = [
        {
            ...
            description: 'Our first engine-powered solution—EduSpace—has been selected for presentation at the University of Malawi EdTech conference.',
            fullDescription: 'This validates what we\'re building: • Data Intelligence Engine proving itself in real classrooms • Workflow Automation delivering value to parents • A Malawian-built engine competing globally',
        ...
        },
        {
            ...
            description: 'Our retail intelligence engine is under construction. Same Data Intelligence + Workflow Automation cores, now applied to e-commerce.',
            category: 'DEVELOPMENT',
            icon: <Code className="h-5 w-5" />,
            date: 'January 10, 2026',
            tags: ['E-commerce', 'Retail Engine', 'Development'],
        ...
        },
        {
            ...
            description: 'The engineer behind our engines combines pedagogical expertise with technical skills—building what teachers actually need.',
            category: 'MILESTONE',
            icon: <GraduationCap className="h-5 w-5" />,
            date: 'March 1, 2024',
            tags: ['Education', 'Founder', 'Engine Building'],
        ...
        },
        {
            ...
            description: 'Mzatinova Labs is scaling up—feeding intelligence into every engine: healthcare, agriculture, and education.',
            category: 'RESEARCH',
            icon: <TrendingUp className="h-5 w-5" />,
            date: 'February 28, 2024',
            tags: ['AI', 'Research', 'Mzatinova Labs'],
    ...
    const upcomingEvents = [
        {
            ...
            description: 'Presenting EduSpace and networking with education innovators.',
            status: 'Confirmed'
        },
        {
            id: 2,
            ...
            date: 'Q3 2024',
            location: 'Online',
            description: 'Limited beta release of our retail intelligence engine.',
            status: 'Planned'
        },
        {
            id: 3,
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
                        Tracking the <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Engine Journey</span>
                    </h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
                    {/* Featured Update - EduSpace at EdTech */}
                                ...
                                <div className="bg-gradient-to-r from-blue-900/30 to-purple-900/30 border border-blue-500/20 rounded-xl p-4 mb-6">
                                    ...
                                    <ul className="space-y-2">
                                        <li className="text-gray-300 text-sm flex items-start gap-2">
                                            ...
                                            <span><span className="text-blue-400 font-medium">Data Intelligence Engine</span> proving itself in real classrooms</span>
                                        </li>
                                        <li className="text-gray-300 text-sm flex items-start gap-2">
                                            <span className="text-blue-400">•</span>
                                            <span><span className="text-purple-400 font-medium">Workflow Automation</span> delivering value to parents</span>
                                        </li>
                                        <li className="text-gray-300 text-sm flex items-start gap-2">
                                            <span className="text-blue-400">•</span>
                                            <span>A Malawian-built engine competing globally</span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div className="bg-gradient-to-r from-blue-900/30 to-purple-900/30 border border-blue-500/20 rounded-xl p-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-300">12-13 May 2026 • University of Malawi, Zomba</p>
                                        </div>
                                    </div>
                                </div>
                            </CardContent>
