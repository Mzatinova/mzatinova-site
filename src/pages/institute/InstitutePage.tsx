...
import { GraduationCap, Code, Laptop, TabletSmartphone, Monitor, Award, Rocket, Clock, Users, CheckCircle, Shield, TrendingUp, Star } from 'lucide-react';
...
const InstitutePage = () => {
    return (
        <div className="bg-gray-100 min-h-screen flex flex-col">
            ...
            <section className="relative bg-gradient-to-br from-gray-900 to-blue-900 text-white py-24 overflow-hidden">
                ...
                <div className="container mx-auto px-6 text-center relative z-10">
                    <div className="flex flex-col items-center mb-6">
                        ...
                        <h1 className="text-4xl md:text-6xl font-bold leading-tight"> {/* Made this larger */}
                            Mzatinova Digital Institute
                        </h1>
                    </div>

                    <h2 className="text-2xl md:text-3xl font-bold mb-6"> {/* Made this smaller */}
                ...
                <div className="container mx-auto px-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            <div
                                key={index}
                                className="bg-white/95 backdrop-blur-sm rounded-xl p-6 border border-gray-200/50 hover:border-blue-300/30 transition-all hover:shadow-lg"
                            >
                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="mb-20">
                        <h3 className="text-2xl font-bold mb-8 flex items-center text-gray-900">
                            <Laptop className="h-6 w-6 mr-3 text-blue-500" />
                            Computer Users
                        </h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                                ...
                                >
                                    ...
                                    <h4 className="text-xl font-bold mb-2 text-gray-900">{path.level}</h4>
                                    <p className="text-gray-600 mb-4">{path.description}</p>
                                    <div className="mb-4">
                                        <h5 className="font-medium mb-2 text-gray-900">Skills Covered:</h5>
            ...
            <section className="py-16">
                <div className="container mx-auto px-6">
                    <div className="bg-gradient-to-r from-blue-50/80 to-blue-100/50 rounded-xl p-8 md:p-12 backdrop-blur-sm border border-blue-200/30">
                        <div className="flex flex-col md:flex-row items-center">
                            <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
                                ...
                                <h3 className="text-3xl font-bold mb-4 text-gray-900">AI App Builder</h3>
                                <p className="text-gray-600 mb-6">
                                    Generate mobile and web applications instantly with AI. Perfect for learning and prototyping.
                                </p>
                                <div className="bg-white/95 backdrop-blur-sm rounded-lg p-6 shadow-sm mb-6 border border-gray-200/50">
                                    <h4 className="font-bold mb-3 text-gray-900">Create Mobile App</h4>
                                    <div className="space-y-4">
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 mb-1">App Name</label>
                                            <input
                                                type="text"
                                                className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 bg-white/80"
                                                placeholder="My Awesome App"
                                            />
                                        </div>
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 mb-1">Describe your app idea</label>
                                            <textarea
                                                rows={3}
                                                className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 bg-white/80"
                                                placeholder="An app that helps people learn coding through gamification..."
                                            ></textarea>
                                        </div>
                            ...
                            <div className="md:w-1/2">
                                <div className="bg-white/95 backdrop-blur-sm p-4 rounded-lg shadow-lg border border-gray-200/50">
                                    <div className="bg-gray-100/80 rounded-md p-4 h-64 flex items-center justify-center">
                                        <div className="text-center">
                                            <Code className="h-12 w-12 mx-auto text-gray-400 mb-4" />
                                            <p className="text-gray-500">Your AI-generated app preview will appear here</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section className="py-16 bg-white/80 backdrop-blur-sm">
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                        {[
                            ...
                            >
                                <div className="flex items-center mb-4">
                                    {device.icon}
                                    <h3 className="text-xl font-bold ml-3 text-gray-900">{device.name}</h3>
                                </div>
                    ...
                    {/* How It Works */}
                    <div className="bg-white/95 backdrop-blur-sm rounded-xl p-8 border border-gray-200/50">
                            ...
                            {[
                                {
                                    step: "1",
                                    title: "Apply Online",
                                    description: "Submit your device loan request with course enrollment proof"
                                },
                                {
                                    step: "2",
                                    title: "Quick Approval",
                                    description: "Get approved within 24-48 hours based on availability"
                                },
                                {
                                    step: "3",
                                    title: "Pickup & Learn",
                                    description: "Collect your device and start your learning journey"
                                }
                            ].map((step, index) => (
